...
export default function TabLayout() {
  ...
  // Fetch User Data once for the sidebar
  useEffect(() => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Animated.View style={[styles.mainContent, { transform: [{ translateX: contentTranslateX }] }]}>
        {isMenuOpen && (
          <Animated.View style={[styles.overlay, { opacity: overlayOpacity }]}><Pressable style={{ flex: 1 }} onPress={toggleMenu} /></Animated.View>
        )}
        ...
        <View style={[styles.topBlock, { paddingTop: insets.top, height: 70 + insets.top }]}>
          <View style={styles.headerContent}>
            <View style={styles.headerSide}>
              <TouchableOpacity style={styles.menuButton} onPress={toggleMenu} hitSlop={{ top: 20, bottom: 20, left: 20, right: 20 }}>
